...
if [ -z "$MYSQL_DATABASE" ] || [ -z "$MYSQL_USER" ] || [ -z "$MYSQL_PASSWORD" ] ||  [ -z "$WP_USER_LOGIN" ] \
	 [ -z "$WP_USER_PASSWORD" ] || [ -z "$WP_ADMIN_PASSWORD" ] \
...
echo -e "WP_USER_LOGIN:	${BLUE}[$WP_USER_LOGIN]${RESET}" 
echo -e "WP_USER_PASSWORD: 	${BLUE}[$WP_USER_PASSWORD]${RESET}"
